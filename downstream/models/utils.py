...
class Multi_CrossAttention(nn.Module):
    """
    In forward, the first tensor is used for query and the second tensor is used for key/value.
    """
    ...
    def forward(self,x,y,log_seqs):
        """
        Cross-attention: use x as query input and y as key/value input.
        """
