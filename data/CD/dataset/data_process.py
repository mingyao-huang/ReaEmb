...
def main():
    file_path = "./CDs_and_Vinyl.jsonl"
    rating_scores = 0.0
    datas = filter_low_rating(file_path, rating_scores)
    datas = clean_datas(datas)
    user_items = convert_to_sequence(datas)
    user_items, item_set = filter_by_k_core(user_items, min_u_num=3, min_i_num=3, user_ts=6, item_ts=16)
    file_path = "./meta_CDs_and_Vinyl.jsonl"
